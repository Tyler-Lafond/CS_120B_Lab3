...
tests = [ 
    ...
    {'description': 'PINA: 0x02, PINB: 0x03 => PORTC = 0x03',
    'steps': [ {'inputs': [('PINA',0x02),('PINB', 0x03)], 'iterations': 1 } ],
    'expected': [('PORTC',0x03)],
    },
    {'description': 'PINA: 0x0A, PINB: 0x0B => PORTC = 0x05',
    'steps': [ {'inputs': [('PINA',0x0A),('PINB', 0x0B)], 'iterations': 1 } ],
    'expected': [('PORTC',0x05)],
    },
